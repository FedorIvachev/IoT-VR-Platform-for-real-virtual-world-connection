...
\begin{figure}
  ...
  \caption{Experiment of the lamp brightness control. In both cases the real lamp and the NUIX-Studio App virtual lamps on Local PC and Oculus Quest brightness have the same value.}
