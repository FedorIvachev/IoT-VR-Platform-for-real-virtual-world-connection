...
\thusetup{
  ...
  title  = {VR-IoT环境下的虚拟世界连接接口研究\\
  \textbf{Research on real-virtual world connection interface for VR-IoT environment}},
  % Input your title* in ENGLISH
  title* = {Research on real-virtual world connection interface for VR-IoT environment},
  %
  % 学位
  %   1. 学术型
  %      - 中文
